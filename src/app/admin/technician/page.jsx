    ...
    <div className="h-screen flex ">
      ...
      <div className="w-[86%] bg-[#F7F8FA] ">
        ...
        <div className="p-4 m-2 bg-white shadow rounded-lg">
          <span className="text-[#50B0E9]">ส่งช่างไปแล้ว</span>
        </div>
        <div className="">
          <div className="p-6 m-2 bg-white shadow rounded-lg">
            ...
            <TableContainer component={Paper}>
              <Table sx={{ minWidth: 650 }} aria-label="customized table">
                <TableHead>
                  <TableRow>
                    <TableCell sx={{ fontWeight: "bold", backgroundColor: "blue", color: "white" }}>เลขแจ้งปัญหา</TableCell>
                    <TableCell sx={{ fontWeight: "bold", backgroundColor: "blue", color: "white" }}>วันที่และเวลา</TableCell>
                    <TableCell sx={{ fontWeight: "bold", backgroundColor: "blue", color: "white" }}>เรื่อง</TableCell>
                    <TableCell sx={{ fontWeight: "bold", backgroundColor: "blue", color: "white" }}>ประเภทปัญหา</TableCell>
                    <TableCell sx={{ fontWeight: "bold", backgroundColor: "blue", color: "white" }}>ผู้แจ้ง</TableCell>
                    <TableCell sx={{ fontWeight: "bold", backgroundColor: "blue", color: "white" }}>สาขา</TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
                  {issues
